#!/bin/bash
# Fake agent that passes auth but dies with out-of-tokens.
...
echo ""
echo "  Agent session started (fake-out-of-tokens)"
echo "  > Analyzing codebase..."
sleep 1
echo "  > Generating changes..."
sleep 1
echo ""
echo "  Error: Token budget exhausted (150,000 / 150,000 tokens used)"
